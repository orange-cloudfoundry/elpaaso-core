 ...
 * space name
 * <P>
 *  Reuse same algorithm as docker to generate unique space names.
...
public class SpaceName {
	...
	private static final String[] left = {"happy", "jolly", "dreamy", "sad", "angry", "pensive", "focused", "sleepy", "grave", "distracted", "determined", "stoic", "stupefied", "sharp", "agitated", "cocky", "tender", "goofy", "furious", "desperate", "hopeful", "compassionate", "silly", "lonely", "condescending", "naughty", "kickass", "drunk", "boring", "nostalgic", "ecstatic", "insane", "cranky", "mad", "jovial", "sick", "hungry", "thirsty", "elegant", "backstabbing", "clever", "trusting", "loving", "suspicious", "berserk", "high", "romantic", "prickly", "evil", "admiring", "adoring", "reverent", "serene", "fervent", "modest", "gloomy", "elated"};
			...
			// Muhammad ibn Jabir al Harrani al Battani was a founding father of astronomy. http://en.wikipedia.org/wiki/Mu%E1%B8%A5ammad_ibn_J%C4%81bir_al-%E1%B8%A4arr%C4%81n%C4%AB_al-Batt%C4%81n%C4%AB
	...
	public static SpaceName randomSpaceNameWithSuffix(String suffix) {
		String value = new StringBuilder().append(left[new Random().nextInt(left.length -1)]).append("-").append(right[new Random().nextInt(right.length -1)]).append("-").append(suffix).toString();
		return new SpaceName(value);
	}

	private void setValue(String value) {
		Assert.hasText(value,"Fail to create space name. space name should not be empty.");
		this.value = value;
	}
