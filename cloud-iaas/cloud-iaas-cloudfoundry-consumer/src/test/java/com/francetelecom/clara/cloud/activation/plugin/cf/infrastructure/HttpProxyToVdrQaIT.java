...
@ContextConfiguration(locations = "classpath:/com/francetelecom/clara/cloud/activation/plugin/cf/infrastructure/CfBindingAdapterIT-context.xml")


public class HttpProxyToVdrQaIT {

	private static final Logger logger = LoggerFactory.getLogger(HttpProxyToVdrQaIT.class);
...
//	@Qualifier("cfOnlineConsumer")
	...
	public void it_gets_injected_the_external_proxy_host_and_port() throws IOException {
		...
		URL url = new URL("https://api.cf.internal-qa.paas/info");
