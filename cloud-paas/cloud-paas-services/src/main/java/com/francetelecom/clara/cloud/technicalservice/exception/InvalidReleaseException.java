...
public class InvalidReleaseException extends BusinessException {
	...
	public InvalidReleaseException(String message, Throwable cause) {
		super(message, cause);
	}

	public InvalidReleaseException(Throwable cause) {
		super(cause);
	}
