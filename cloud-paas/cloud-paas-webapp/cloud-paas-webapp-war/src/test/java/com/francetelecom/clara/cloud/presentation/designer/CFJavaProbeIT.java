 ...
 * User: shjn2064
 */
public class CFJavaProbeIT extends AbstractTestApplication {
    ...
    public CFJavaProbeIT(){
        enableOnlyCfJavaProcessingTest();
    }
    ...
    private void goOnGoodPage() {
        ...
        CreateObjectsWithGUI.selectService(getMyTester(), CFJavaProcessing.class);
    }
