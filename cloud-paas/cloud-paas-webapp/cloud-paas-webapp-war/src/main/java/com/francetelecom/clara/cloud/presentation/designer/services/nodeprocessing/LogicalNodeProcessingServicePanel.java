 ...
 */
package com.francetelecom.clara.cloud.presentation.designer.services.nodeprocessing;
 ...
 * Date: 03/01/12
 */
public class LogicalNodeProcessingServicePanel<L extends LogicalModelItem> extends LogicalServiceBasePanel<L> {

	private static final long serialVersionUID = 2057111324244846261L;
	
	public LogicalNodeProcessingServicePanel(String id, IModel<L> model, Page parentPage,
    ...
    private void initComponents() {
    	...
    	getServiceForm().add(new CacheActivatedImage("nodeprocessingIcon",new ResourceModel("nodeprocessing-icon").getObject()));
    	// Online help link
...
*/
    ...
    protected void setCustomIconAndUpdateFeedBack(WebMarkupContainer image, TextField<String> iconUrl, Label feedback) {
    ...
    protected void setDefaultIconAndUpdateFeedBack(WebMarkupContainer image, Label feedback, String detailedErrorMessage) {
        image.add(new AttributeModifier("style",new Model<String>("background-image:url(\"../../../../../images/designer/jee-processing-icon.png\"); background-repeat:no-repeat; background-position:5px 5px")));
        if (feedback != null) {
