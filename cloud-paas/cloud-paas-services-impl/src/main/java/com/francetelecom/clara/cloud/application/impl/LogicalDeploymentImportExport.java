...
import com.francetelecom.clara.cloud.dao.impl.LogicalDeploymentClonerImpl;
...
public class LogicalDeploymentImportExport {
    ...
    String exportDump(LogicalDeployment logicalDeployment) {
...
ProcessingNode executionNode = association.getProcessingNode();
    ...
    void renameDuplicatesLogicalItems(LogicalDeployment original, LogicalDeployment duplicate) {
