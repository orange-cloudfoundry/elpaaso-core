...
import com.francetelecom.clara.cloud.logicalmodel.samplecatalog.OutOfOrderProbeLogicalModelCatalog;
...
public class PaasServicesEnvOutOfOrderProbeITContext {

    @Bean(name="logicalModelCatalog")
    public SampleAppFactory getLogicalModelCatalog(){
        return new OutOfOrderProbeLogicalModelCatalog();
    }
