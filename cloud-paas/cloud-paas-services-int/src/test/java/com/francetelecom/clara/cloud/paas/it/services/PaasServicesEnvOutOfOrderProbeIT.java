...
@ContextConfiguration(classes= PaasServicesEnvOutOfOrderProbeITContext.class)
@RunWith(SpringJUnit4ClassRunner.class)
public class PaasServicesEnvOutOfOrderProbeIT {

    protected static Logger logger = LoggerFactory.getLogger(PaasServicesEnvOutOfOrderProbeIT.class);
    ...
    public void setup() {
        ...
        paasServicesEnvITHelper.setEnvironmentExpectedStatus(EnvironmentDto.EnvironmentStatusEnum.FAILED);
    ...
    public void application_should_be_accessible() {
        paasServicesEnvITHelper.application_should_be_accessible(false);
    }
