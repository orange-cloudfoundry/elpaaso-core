...
import org.springframework.test.context.junit4.SpringJUnit4ClassRunner;
 ...
 /**
  * PaasServicesEnvRabbitProbeIT  : probe for rabbitmq, profile 2.0.0
  *
  */
 @ContextConfiguration
 @RunWith(SpringJUnit4ClassRunner.class)
 public class PaasServicesEnvRabbitProbeIT {
     protected static Logger logger = LoggerFactory.getLogger(PaasServicesEnvRabbitProbeIT.class);
