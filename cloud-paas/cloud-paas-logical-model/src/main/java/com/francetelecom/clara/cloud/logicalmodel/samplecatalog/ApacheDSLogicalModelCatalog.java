...
/**
 * apache DS LogicalModel Sample
 */
public class ApacheDSLogicalModelCatalog extends BaseReferenceLogicalModelsCatalog {

    String APP_CODE = "apacheDS";
    ...
    public LogicalDeployment createLogicalModel(String logicalModelName, LogicalDeployment existingLDToUpdate) {
		...
		LogicalWebGUIService webGui = createLogicalWebGuiService("ApacheDSWebUI", APP_CODE, true, false, 1, 20);
		ProcessingNode jeeProcessing = createJeeProcessing(this, "ApacheDSExecNode", APP_CODE);
    ...
    public String getAppDescription() {
        return "ApacheDSSample description";
    }

    @Override
    public String getAppCode() {
        return "ApacheDSSampleCODE";
    }

    @Override
    public String getAppLabel() {
        return "ApacheDSSample";
    }

    @Override
    public String getAppReleaseDescription() {
        return "ApacheDSSample release description";
    }
