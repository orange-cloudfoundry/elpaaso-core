 ...
 */
public class CFWicketJpaWithMysqlServiceLogicalModelCatalog extends BaseReferenceLogicalModelsCatalog {
    ...
    public LogicalDeployment createLogicalModel(String logicalModelName, LogicalDeployment existingLDToUpdate) {
        ...
        LogicalMysqlService mysqlService = createLogicalMysqlService("db", "mysql-db");
        ...
        cfJavaProcessing.addLogicalServiceUsage(mysqlService, LogicalServiceAccessTypeEnum.NOT_APPLICABLE);
