...
/**
 * Sample logical model for the orange dbaas portal.<br>
 */
public class DbaasPortalLogicalModelCatalog extends BaseReferenceLogicalModelsCatalog {

	String APP_CODE = "dbaas.portal";
	...
	public LogicalDeployment createLogicalModel(String logicalModelName, LogicalDeployment existingLDToUpdate) {
		...
		// WAR "dbaas-portal"
		ProcessingNode cfProcessing = createCFJavaProcessing(this, "dbaas-portal", APP_CODE,ArtefactType.war);
		existingLDToUpdate.addExecutionNode(cfProcessing);

		// Update context root of webGUI
		LogicalWebGUIService web = createLogicalWebGuiService("dbaas-portal-webui", APP_CODE, true, false, 1, 20, ArtefactType.war);
		...
		try {
			LogicalConfigService config=new LogicalConfigService("dbaas-portal-config", existingLDToUpdate, configSetContent);
    ...
    public String getAppDescription() {
		return "Dbaas portal is the end user portal for Orange DBaas.";
    }
