...
import com.francetelecom.clara.cloud.paas.activation.v1.async.message.ErrorMessage;
...
public class ErrorMessageListener implements MessageListener {
	...
	public void onMessage(Message message) {
		...
		try {
			...
			ErrorMessage msg = new ErrorMessage((ObjectMessage) message);
			Throwable error = (Throwable) msg.getObject();
