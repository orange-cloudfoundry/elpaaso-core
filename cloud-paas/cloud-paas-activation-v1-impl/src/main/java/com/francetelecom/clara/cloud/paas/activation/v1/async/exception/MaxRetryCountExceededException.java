 ...
 * 
 */
public class MaxRetryCountExceededException extends RuntimeException implements
		Serializable {
	...
	public MaxRetryCountExceededException(String message) {
		super(message);
		localisationClass = "";
		localisationMethod = "";
	}

	public MaxRetryCountExceededException(String message, Throwable cause) {
		super(message, cause);
		localisationClass = "";
		localisationMethod = "";
	}

	public MaxRetryCountExceededException(Throwable cause) {
		super(cause);
		localisationClass = "";
		localisationMethod = "";
	}

	public MaxRetryCountExceededException(String clazz, String method,
			String message) {
		super(message);
