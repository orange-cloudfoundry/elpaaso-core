...
public class EnvironmentRepositoryTest {
	...
	public void testPersist() {
		...
		environmentRepository.persist(env);
	...
	private void assertFindEnvById(int envId, boolean expectsEnvToBePresent, Environment expectedDetachedEnv) {
		Environment lookedUpEnv = environmentRepository.find(envId);
	...
	public void shouldFindExistingEnvironmentByUID() {
		...
		environmentRepository.persist(persisted);
	...
	public void should_remove_environment() {
		...
		environmentRepository.persist(env);
		assertFindEnvById(env.getId(), true, env);
		environmentRepository.remove(env);
		environmentRepository.flush();
	...
	public void should_find_all_environments() {
		...
		environmentRepository.persist(env1);
		...
		environmentRepository.persist(env2);
	...
	public void testFindAllActiveWithCount() {
		...
		List<Environment> entities = environmentRepository.findAllActive(0, 2);
	...
	public void testCount() {
		...
		environmentRepository.persist(environment1);
		...
		environmentRepository.persist(environment2);
		environmentRepository.flush();
	...
	public void should_find_active_environments_for_given_member() throws MalformedURLException {
		...
		Environment myOrange_1_0_env_1 = new Environment(DeploymentProfileEnum.DEVELOPMENT, "anotherLabel", myOrange_1_0, manager,
				technicalDeploymentInstance);
		environmentRepository.persist(myOrange_1_0_env_1);
		...
		List<Environment> jdaltonEnvs = environmentRepository.findAllActiveByApplicationMember(new SSOId("jdalton"), 0, Integer.MAX_VALUE, "label", "ASC");
		List<Environment> aliceEnvs = environmentRepository.findAllActiveByApplicationMember(new SSOId("alice123"), 0, Integer.MAX_VALUE, "label", "ASC");
		List<Environment> bobEnvs = environmentRepository.findAllActiveByApplicationMember(new SSOId("bob123"), 0, Integer.MAX_VALUE, "label", "ASC");
	...
	public void should_find_public_environments_or_private_environment_for_given_member() throws MalformedURLException {
		...
		// assertions
		// when I find all active environments
		List<Environment> jdaltonEnvs = environmentRepository.findAllPublicOrPrivateByMember(new SSOId("jdalton"), 0, Integer.MAX_VALUE, "label", "ASC");
		List<Environment> aliceEnvs = environmentRepository.findAllPublicOrPrivateByMember(new SSOId("alice123"), 0, Integer.MAX_VALUE, "label", "ASC");
		List<Environment> bobEnvs = environmentRepository.findAllPublicOrPrivateByMember(new SSOId("bob123"), 0, Integer.MAX_VALUE, "label", "ASC");
	...
	public void should_count_active_environments_for_given_member() throws MalformedURLException {
		...
		// assertions
		// when I find all active environments
		Long jdaltonEnvs = environmentRepository.countActiveByApplicationMember(new SSOId("jdalton"));
		Long aliceEnvs = environmentRepository.countActiveByApplicationMember(new SSOId("alice123"));
		Long bobEnvs = environmentRepository.countActiveByApplicationMember(new SSOId("bob123"));
	...
	@Test
	@Transactional
	public void should_find_active_environments_for_given_release_and_member() throws MalformedURLException {
		// given joyn application
		Application joyn = new Application("joyn", "joyn");
		HashSet<SSOId> joynMembers = new HashSet<>();
		joynMembers.add(new SSOId("bob123"));
		...
		// assertions
		// when I find all active environments
		List<Environment> jdaltonEnvs = environmentRepository.findAllByApplicationReleaseUidAndApplicationMember(joyn_1_0.getUID(),new SSOId("jdalton"), 0, Integer.MAX_VALUE, "label", "ASC");
		List<Environment> aliceEnvs = environmentRepository.findAllByApplicationReleaseUidAndApplicationMember(joyn_1_0.getUID(),new SSOId("alice123"), 0, Integer.MAX_VALUE, "label", "ASC");
		List<Environment> bobEnvs = environmentRepository.findAllByApplicationReleaseUidAndApplicationMember(joyn_1_0.getUID(),new SSOId("bob123"), 0, Integer.MAX_VALUE, "label", "ASC");

		Assert.assertEquals("jdalton should see no environment", 0, jdaltonEnvs.size());
		Assert.assertEquals("alice should see 2 environments", 2, aliceEnvs.size());
		Assert.assertTrue("alice should see joyn_1_0_env_1", aliceEnvs.contains(joyn_1_0_env_1));
		Assert.assertTrue("alice should see joyn_1_0_env_2",aliceEnvs.contains(joyn_1_0_env_2));
		Assert.assertEquals("bob should see 2  environments", 2, bobEnvs.size());
		Assert.assertTrue("bob should see joyn_1_0_env_1", bobEnvs.contains(joyn_1_0_env_1));
		Assert.assertTrue("bob should see joyn_1_0_env_2",bobEnvs.contains(joyn_1_0_env_2));
	...
	public void should_find_active_public_environments_or_environment_by_member_for_given_release() throws MalformedURLException {
		...
		// assertions
		// when I find all active environments
		List<Environment> jdalton_joyn_1_0_envs = environmentRepository.findAllPublicOrPrivateByMemberAndByApplicationRelease(joyn_1_0.getUID(),new SSOId("jdalton"), 0, Integer.MAX_VALUE, "label", "ASC");
		List<Environment> alice_joyn_1_0_envs = environmentRepository.findAllPublicOrPrivateByMemberAndByApplicationRelease(joyn_1_0.getUID(),new SSOId("alice123"), 0, Integer.MAX_VALUE, "label", "ASC");
		List<Environment> bob_joyn_1_0_envs = environmentRepository.findAllPublicOrPrivateByMemberAndByApplicationRelease(joyn_1_0.getUID(),new SSOId("bob123"), 0, Integer.MAX_VALUE, "label", "ASC");
		...
		List<Environment> jdalton_elpaaso_1_0_envs = environmentRepository.findAllPublicOrPrivateByMemberAndByApplicationRelease(elpaaso_1_0.getUID(),new SSOId("jdalton"), 0, Integer.MAX_VALUE, "label", "ASC");
		List<Environment> alice_elpaaso_1_0_envs = environmentRepository.findAllPublicOrPrivateByMemberAndByApplicationRelease(elpaaso_1_0.getUID(),new SSOId("alice123"), 0, Integer.MAX_VALUE, "label", "ASC");
		List<Environment> bob_elpaaso_1_0_envs = environmentRepository.findAllPublicOrPrivateByMemberAndByApplicationRelease(elpaaso_1_0.getUID(),new SSOId("bob123"), 0, Integer.MAX_VALUE, "label", "ASC");
	...
	public void should_count_active_public_environments_or_environment_by_member_for_given_release() throws MalformedURLException {
		...
		long jdalton_joyn_1_0_envs = environmentRepository.countAllPublicOrPrivateByMemberAndByApplicationRelease(joyn_1_0.getUID(),new SSOId("jdalton"));
		long alice_joyn_1_0_envs = environmentRepository.countAllPublicOrPrivateByMemberAndByApplicationRelease(joyn_1_0.getUID(),new SSOId("alice123"));
		long bob_joyn_1_0_envs = environmentRepository.countAllPublicOrPrivateByMemberAndByApplicationRelease(joyn_1_0.getUID(),new SSOId("bob123"));
		...
		long jdalton_elpaaso_1_0_envs = environmentRepository.countAllPublicOrPrivateByMemberAndByApplicationRelease(elpaaso_1_0.getUID(),new SSOId("jdalton"));
		long alice_elpaaso_1_0_envs = environmentRepository.countAllPublicOrPrivateByMemberAndByApplicationRelease(elpaaso_1_0.getUID(),new SSOId("alice123"));
		long bob_elpaaso_1_0_envs = environmentRepository.countAllPublicOrPrivateByMemberAndByApplicationRelease(elpaaso_1_0.getUID(),new SSOId("bob123"));
	...
	public void should_count_public_environments_or_private_environment_for_given_member() throws MalformedURLException {
		...
		// assertions
		// when I count all active environments
		long jdaltonEnvs = environmentRepository.countPublicOrPrivateByMember(new SSOId("jdalton"));
		long aliceEnvs = environmentRepository.countPublicOrPrivateByMember(new SSOId("alice123"));
		long bobEnvs = environmentRepository.countPublicOrPrivateByMember(new SSOId("bob123"));
